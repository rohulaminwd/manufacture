...
const Banner = () => {
    return (
        <div class="hero mt-16 lg:py-16 bg-cyan-100 lg:w-full">
            <div class="hero-content mx-2 sm:mx-4 md:mx-8 lg:mx-16 flex-col lg:flex-row-reverse">
                <div className="">
                ...
                <p class="my-2 lg:my-4 sm:w-3/4"  data-aos="zoom-in-right" data-aos-delay="500" data-aos-duration="800">Keep Your Vehicle in Great Condition with Top Auto Parts, Engineered for your best workout yet, Select YOur auto parts..</p>
